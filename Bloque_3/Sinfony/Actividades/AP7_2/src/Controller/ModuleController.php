...
final class ModuleController extends AbstractController
{
    ...
    #[Route('/{id}/listado', name: 'app_module_listadoAlumnos', methods: ['GET'])]
    public function listadoAlumnos(Module $module): Response
    {
        $total = count($module->getIdStudent());
        return $this->render('module/listadoAlumnos.html.twig', [
            'module' => $module,
            'total' => $total
        ]);
    }
